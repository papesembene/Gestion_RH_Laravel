        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card card-height">
                        <div class="card-body">
                            <h5 class="card-title"><i class="fas fa-calendar-day"></i> Congés en Attente</h5>
                            <p class="card-text">{{$pendingConges}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-height">
                        <div class="card-body">
                            <h5 class="card-title"><i class="fas fa-calendar-check"></i> Congés Acceptés</h5>
                            <p class="card-text">{{$acceptedConges}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-height">
                        <div class="card-body">
                            <h5 class="card-title"><i class="fas fa-calendar-times"></i> Congés Rejetés</h5>
                            <p class="card-text">{{$rejectedConges}}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card card-height">
                        <div class="card-body">
                            <h5 class="card-title"><i class="fas fa-user-slash"></i> Absences</h5>
